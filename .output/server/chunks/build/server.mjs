...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-F1CF2usM.mjs')
  },
  {
    name: "Account",
    path: "/Account",
    component: () => import('./Account-RO5AEP57.mjs')
  },
  {
    name: "AIModel",
    path: "/AIModel",
    component: () => import('./AIModel-BoB2Yx1I.mjs')
  },
  {
    name: "Activity",
    path: "/Activity",
    component: () => import('./Activity-CooIhiG9.mjs')
  },
  {
    name: "Datasets",
    path: "/Datasets",
    component: () => import('./Datasets-v6_C0wQL.mjs')
  },
  {
    name: "Settings",
    path: "/Settings",
    component: () => import('./Settings-DXrDS_n7.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bq8t9v_L.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BBarA_35.mjs'));
